            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                         <h3 class="title-5 m-b-35">Manajemen Mata Pelajaran</h3>
                                ...
                                <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                ...
                                                <small class="form-text text-muted">Nama Mata Pelajaran Harap di sesuaikan lagi</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="deskripsi" id="desk" rows="9" placeholder="Deskripsi..." class="form-control"><?= $mapel[0]->info?></textarea>
                                            </div>
                                        </div>
                                        <div class="col col-md-3">
