                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck1" name="status" <?php if ($status==1): ?>
                                    checked
                                <?php endif ?> value="1">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a href="<?=base_url()?>admin/editKelas/<?=$key->id?>" class="btn btn-primary">Edit</a></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                        </table>
